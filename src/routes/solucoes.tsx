  ...
  return (
    <SiteLayout>
      ...
      <Block
        icon={HandHeart}
        anchor="vivenciais"
        eyebrow="Experiências Vivenciais"
        title="Aprender é mais significativo quando conecta experiência, reflexão e aplicação prática."
        text="As experiências promovem interação, fortalecimento de vínculos, colaboração e maior retenção do aprendizado, conectando desafios reais ao desenvolvimento de competências e à aplicação de novos comportamentos no contexto organizacional."
        examples={[
          "Projeto Travessia",
      ...
      >
        <div className="grid items-stretch gap-5 sm:grid-cols-2">
          ...
          <article className="flex h-full flex-col overflow-hidden rounded-2xl border border-cream/15 bg-cream/5 shadow-sm">
            <video
            ...
            <div className="flex flex-1 flex-col p-5">
              ...
              <p className="mt-2 flex-1 text-sm leading-relaxed text-cream/75">
                Jogo corporativo autoral que desafia os participantes a planejar, tomar decisões e
                construir uma ponte de forma colaborativa.
              </p>
